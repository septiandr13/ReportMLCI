    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MasterHeaderClause>(entity =>
            {
                ...
                // Configure relationship with MasterClause
                entity.HasMany(h => h.MasterClauses)
                      .WithOne(c => c.MasterHeaderClause)
                      .HasForeignKey(c => c.MasterHeaderClauseId)
            ...
            modelBuilder.Entity<MasterClause>(entity =>
            {
                ...
                // Configure relationship with MasterClausesDetails
                entity.HasMany(c => c.MasterClausesDetails)
                      .WithOne()
            ...
            { 
                ...
                // Configure relationship with MasterClausesSubDetails
                entity.HasMany(d => d.MasterClausesSubDetails)
                      .WithOne()
                      .HasForeignKey(s => s.MasterClauseDetailId)
                      .OnDelete(DeleteBehavior.Cascade);
            });
